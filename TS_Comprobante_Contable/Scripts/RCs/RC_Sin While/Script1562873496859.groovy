...
WebUI.callTestCase(findTestCase('CC/CC_Crea_Enca/TC_CC_Crea_Enca'), [('XLS_No_Comprobante_Enca') : XLS_No_Comprobante_Enca
...
WebUI.callTestCase(findTestCase('CC/CC_Crea_Secu/TC_CC_Crea_Secu Con While'), [('XLS_No_Comprobante_Secu') : XLS_No_Comprobante_Secu
        , ('XLS_Tipo_Cuenta') : XLS_Tipo_Cuenta, ('XLS_Cuenta') : XLS_Cuenta, ('XLS_Descripcion') : XLS_Descripcion, ('XLS_NitTercero') : XLS_NitTercero
        , ('XLS_Debito_o_Credito') : XLS_Debito_o_Credito, ('XLS_Valor') : XLS_Valor, ('XLS_Secuencia') : XLS_Secuencia], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('CC/Crea_Pie/TC_Crea_Pie'), [('XLS_No_Comprobante_Enca') : XLS_No_Comprobante_Enca, ('XLS_Observaciones_Nota_Interna') : XLS_Observaciones_Nota_Interna], 
    FailureHandling.STOP_ON_FAILURE)
